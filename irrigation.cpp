...
/*
* This is a graph problem and not a greedy problem. MST tree.
* Use Prims or Kruskal algorithm are acceptable since this is a fully connected graph.
* Just add the condition that if the cost is less then C (cost < C), then use the next best edge.
*/
